...
## Paquete: **`ejercicios.gestionempleados`**
...
## Paquete: `ejercicios.gestionhospital`
...
## Paquete: `ejercicios.contrarreloj`
...
## Paquete: `ejercicios.reservasLibreria`
...
## Paquete: `ejercicios.gestorCorreoElectronico`
...
## Paquete: `ejercicios.juegodecartas`
...
## Paquete: `ejercicios.gestorvuelos`
...
1. Implementación de la clase **Vuelo**, que permite representar un vuelo mediante los atributos:  
   ...
   - `public Vuelo(String id, String orig, String dest, Tiempo hsal, Tiempo hlleg)`. **Constructor** que crea un vuelo con identificador, ciudad de origen, ciudad de destino, hora de salida y hora de llegada indicados en los respectivos parámetros, y sin pasajeros.
